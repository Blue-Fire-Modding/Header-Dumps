...
class USequenceDirector_C : ULevelSequenceDirector
{
    ...
    void SequenceEvent__ENTRYPOINTSequenceDirector_0(USteamHouseActioner_C* SteamMachineActivator_1);
