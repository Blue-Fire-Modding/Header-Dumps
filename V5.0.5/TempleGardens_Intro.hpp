#ifndef UE4SS_SDK_TempleGardens_Intro_HPP
#define UE4SS_SDK_TempleGardens_Intro_HPP

class USequenceDirector_C : ULevelSequenceDirector
{
    FPointerToUberGraphFrame UberGraphFrame;

    void SequenceEvent__ENTRYPOINTSequenceDirector_0(UCinematic_Area_Intro_C* Cinematic_Area_Intro3);
