#ifndef UE4SS_SDK_SteamHouseMachine2_HPP
#define UE4SS_SDK_SteamHouseMachine2_HPP

class USequenceDirector_C : ULevelSequenceDirector
{
    FPointerToUberGraphFrame UberGraphFrame;

    void SequenceEvent__ENTRYPOINTSequenceDirector_0(USteamHouseActioner_C* SteamMachineActivator_2);
