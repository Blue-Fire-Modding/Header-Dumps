...
class ADebugTools_Control_C : public AActor
{
    ...
    bool Up;
    FVector SavedPoint;
    class UDebugTools_UI_C* DebugTools_UI;
    bool ShouldMoveUp;

    void InpActEvt_H_K2Node_InputKeyEvent_46(FKey Key);
    ...
    void ExecuteUbergraph_DebugTools_Control(int32 EntryPoint);
};
