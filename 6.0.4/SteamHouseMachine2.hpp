...
class USequenceDirector_C : public ULevelSequenceDirector
{
    ...
    void SequenceEvent__ENTRYPOINTSequenceDirector_0(class ASteamHouseActioner_C* SteamMachineActivator_2);
    ...
    void SteamMachineActivator_2_Event_0(class ASteamHouseActioner_C* SteamMachineActivator_2);
