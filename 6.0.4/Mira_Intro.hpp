#ifndef UE4SS_SDK_Mira_Intro_HPP
#define UE4SS_SDK_Mira_Intro_HPP

class USequenceDirector_C : public ULevelSequenceDirector
{
    FPointerToUberGraphFrame UberGraphFrame;

    void SequenceEvent__ENTRYPOINTSequenceDirector_3(class AMira_Intro_Controller_C* Mira_Intro_Controller);
    void SequenceEvent__ENTRYPOINTSequenceDirector_2(class AMira_Intro_Controller_C* Mira_Intro_Controller);
    ...
    void Mira_Intro_Controller_Event_2(class AMira_Intro_Controller_C* Mira_Intro_Controller);
    void Mira_Intro_Controller_Event_3(class AMira_Intro_Controller_C* Mira_Intro_Controller);
    void Mira_Intro_Controller_Event_4(class AMira_Intro_Controller_C* Mira_Intro_Controller);
    void Mira_Intro_Controller_Event_5(class AMira_Intro_Controller_C* Mira_Intro_Controller);
